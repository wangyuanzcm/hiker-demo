 ...
 */ /* eslint-env node */ "use strict";
                var _adapter_factory = require1("./adapter_factory.js");
                var adapter = (0, _adapter_factory.adapterFactory)({
                    window: typeof window === "undefined" ? undefined : window
                });
                module1.exports = adapter; // this is the difference from adapter_core.
            },
            {
        ...
        2: [
            function(require1, module1, exports1) {
                ...
                exports1.adapterFactory = adapterFactory;
                var _utils = require1("./utils");
                var utils = _interopRequireWildcard(_utils);
                var _chrome_shim = require1("./chrome/chrome_shim");
                var chromeShim = _interopRequireWildcard(_chrome_shim);
                var _firefox_shim = require1("./firefox/firefox_shim");
                var firefoxShim = _interopRequireWildcard(_firefox_shim);
                var _safari_shim = require1("./safari/safari_shim");
                var safariShim = _interopRequireWildcard(_safari_shim);
                var _common_shim = require1("./common_shim");
                var commonShim = _interopRequireWildcard(_common_shim);
                var _sdp = require1("sdp");
 ...
 */ function adapterFactory() {
                    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}, window1 = _ref.window;
                    ...
                    var browserDetails = utils.detectBrowser(window1);
                    var adapter = {
                    ...
                    switch(browserDetails.browser){
                        case "chrome":
                            ...
                            commonShim.shimAddIceCandidateNullOrEmpty(window1, browserDetails);
                            commonShim.shimParameterlessSetLocalDescription(window1, browserDetails);
                            chromeShim.shimGetUserMedia(window1, browserDetails);
                            chromeShim.shimMediaStream(window1, browserDetails);
                            chromeShim.shimPeerConnection(window1, browserDetails);
                            chromeShim.shimOnTrack(window1, browserDetails);
                            chromeShim.shimAddTrackRemoveTrack(window1, browserDetails);
                            chromeShim.shimGetSendersWithDtmf(window1, browserDetails);
                            chromeShim.shimGetStats(window1, browserDetails);
                            chromeShim.shimSenderReceiverGetStats(window1, browserDetails);
                            chromeShim.fixNegotiationNeeded(window1, browserDetails);
                            commonShim.shimRTCIceCandidate(window1, browserDetails);
                            commonShim.shimConnectionState(window1, browserDetails);
                            commonShim.shimMaxMessageSize(window1, browserDetails);
                            commonShim.shimSendThrowTypeError(window1, browserDetails);
                            commonShim.removeExtmapAllowMixed(window1, browserDetails);
                            break;
                        case "firefox":
                            ...
                            commonShim.shimAddIceCandidateNullOrEmpty(window1, browserDetails);
                            commonShim.shimParameterlessSetLocalDescription(window1, browserDetails);
                            firefoxShim.shimGetUserMedia(window1, browserDetails);
                            firefoxShim.shimPeerConnection(window1, browserDetails);
                            firefoxShim.shimOnTrack(window1, browserDetails);
                            firefoxShim.shimRemoveStream(window1, browserDetails);
                            firefoxShim.shimSenderGetStats(window1, browserDetails);
                            firefoxShim.shimReceiverGetStats(window1, browserDetails);
                            firefoxShim.shimRTCDataChannel(window1, browserDetails);
                            firefoxShim.shimAddTransceiver(window1, browserDetails);
                            firefoxShim.shimGetParameters(window1, browserDetails);
                            firefoxShim.shimCreateOffer(window1, browserDetails);
                            firefoxShim.shimCreateAnswer(window1, browserDetails);
                            commonShim.shimRTCIceCandidate(window1, browserDetails);
                            commonShim.shimConnectionState(window1, browserDetails);
                            commonShim.shimMaxMessageSize(window1, browserDetails);
                            commonShim.shimSendThrowTypeError(window1, browserDetails);
                        ...
                        case "safari":
                            ...
                            commonShim.shimAddIceCandidateNullOrEmpty(window1, browserDetails);
                            commonShim.shimParameterlessSetLocalDescription(window1, browserDetails);
                            safariShim.shimRTCIceServerUrls(window1, browserDetails);
                            safariShim.shimCreateOfferLegacy(window1, browserDetails);
                            safariShim.shimCallbacksAPI(window1, browserDetails);
                            safariShim.shimLocalStreamsAPI(window1, browserDetails);
                            safariShim.shimRemoteStreamsAPI(window1, browserDetails);
                            safariShim.shimTrackEventTransceiver(window1, browserDetails);
                            safariShim.shimGetUserMedia(window1, browserDetails);
                            safariShim.shimAudioContext(window1, browserDetails);
                            commonShim.shimRTCIceCandidate(window1, browserDetails);
                            commonShim.shimMaxMessageSize(window1, browserDetails);
                            commonShim.shimSendThrowTypeError(window1, browserDetails);
                            commonShim.removeExtmapAllowMixed(window1, browserDetails);
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.shimGetDisplayMedia = exports1.shimGetUserMedia = undefined;
                var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function(obj) {
                    return typeof obj;
                } : function(obj) {
                    return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
                };
                var _getusermedia = require1("./getusermedia");
                Object.defineProperty(exports1, "shimGetUserMedia", {
                    enumerable: true,
                    get: function get() {
                        return _getusermedia.shimGetUserMedia;
                    }
                });
                var _getdisplaymedia = require1("./getdisplaymedia");
                Object.defineProperty(exports1, "shimGetDisplayMedia", {
                    enumerable: true,
                    get: function get() {
                        return _getdisplaymedia.shimGetDisplayMedia;
                    }
                });
                exports1.shimMediaStream = shimMediaStream;
                exports1.shimOnTrack = shimOnTrack;
                exports1.shimGetSendersWithDtmf = shimGetSendersWithDtmf;
                exports1.shimGetStats = shimGetStats;
                exports1.shimSenderReceiverGetStats = shimSenderReceiverGetStats;
                exports1.shimAddTrackRemoveTrackWithNative = shimAddTrackRemoveTrackWithNative;
                exports1.shimAddTrackRemoveTrack = shimAddTrackRemoveTrack;
                exports1.shimPeerConnection = shimPeerConnection;
                exports1.fixNegotiationNeeded = fixNegotiationNeeded;
                var _utils = require1("../utils.js");
                var utils = _interopRequireWildcard(_utils);
                function _interopRequireWildcard(obj) {
                    if (obj && obj.__esModule) return obj;
                    else {
                ...
                function shimMediaStream(window1) {
                    window1.MediaStream = window1.MediaStream || window1.webkitMediaStream;
                }
                function shimOnTrack(window1) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection && !("ontrack" in window1.RTCPeerConnection.prototype)) {
                        ...
                        var origSetRemoteDescription = window1.RTCPeerConnection.prototype.setRemoteDescription;
                            ...
                            if (!this._ontrackpoly) {
                                this._ontrackpoly = function(e) {
                                    ...
                                    e.stream.addEventListener("addtrack", function(te) {
                                        var receiver = void 0;
                                        if (window1.RTCPeerConnection.prototype.getReceivers) receiver = _this.getReceivers().find(function(r) {
                    ...
                    utils.wrapPeerConnectionEvent(window1, "track", function(e) {
                ...
                function shimGetSendersWithDtmf(window1) {
                    ...
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection && !("getSenders" in window1.RTCPeerConnection.prototype) && "createDTMFSender" in window1.RTCPeerConnection.prototype) {
                        ...
                        if (!window1.RTCPeerConnection.prototype.getSenders) {
                            ...
                            var origAddTrack = window1.RTCPeerConnection.prototype.addTrack;
                            ...
                            var origRemoveTrack = window1.RTCPeerConnection.prototype.removeTrack;
                        ...
                        var origAddStream = window1.RTCPeerConnection.prototype.addStream;
                        ...
                        var origRemoveStream = window1.RTCPeerConnection.prototype.removeStream;
                    ...
                    } else if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection && "getSenders" in window1.RTCPeerConnection.prototype && "createDTMFSender" in window1.RTCPeerConnection.prototype && window1.RTCRtpSender && !("dtmf" in window1.RTCRtpSender.prototype)) {
                        var origGetSenders = window1.RTCPeerConnection.prototype.getSenders;
                        window1.RTCPeerConnection.prototype.getSenders = function getSenders() {
                            var _this4 = this;
                ...
                function shimGetStats(window1) {
                    ...
                    var origGetStats = window1.RTCPeerConnection.prototype.getStats;
                ...
                function shimSenderReceiverGetStats(window1) {
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection && window1.RTCRtpSender && window1.RTCRtpReceiver)) return;
                    // shim sender stats.
                    if (!("getStats" in window1.RTCRtpSender.prototype)) {
                        var origGetSenders = window1.RTCPeerConnection.prototype.getSenders;
                        if (origGetSenders) window1.RTCPeerConnection.prototype.getSenders = function getSenders() {
                            var _this6 = this;
                            var senders = origGetSenders.apply(this, []);
                            senders.forEach(function(sender) {
                        ...
                        var origAddTrack = window1.RTCPeerConnection.prototype.addTrack;
                        if (origAddTrack) window1.RTCPeerConnection.prototype.addTrack = function addTrack() {
                            var sender = origAddTrack.apply(this, arguments);
                            sender._pc = this;
                            return sender;
                        };
           ...
           */ utils.filterStats(result, sender.track, true));
                    ...
                    if (!("getStats" in window1.RTCRtpReceiver.prototype)) {
                        var origGetReceivers = window1.RTCPeerConnection.prototype.getReceivers;
                        if (origGetReceivers) window1.RTCPeerConnection.prototype.getReceivers = function getReceivers() {
                            var _this7 = this;
                    ...
                    if (!("getStats" in window1.RTCRtpSender.prototype && "getStats" in window1.RTCRtpReceiver.prototype)) return;
                ...
                function shimAddTrackRemoveTrack(window1, browserDetails) {
                    ...
                    if (window1.RTCPeerConnection.prototype.addTrack && browserDetails.version >= 65) return shimAddTrackRemoveTrackWithNative(window1);
                    // also shim pc.getLocalStreams when addTrack is shimmed
                    // to return the original streams.
                    var origGetLocalStreams = window1.RTCPeerConnection.prototype.getLocalStreams;
                    window1.RTCPeerConnection.prototype.getLocalStreams = function getLocalStreams() {
                        var _this11 = this;
                    ...
                    window1.RTCPeerConnection.prototype.addStream = function addStream(stream) {
                        ...
                        if (!this._reverseStreams[stream.id]) {
                            var newStream = new window1.MediaStream(stream.getTracks());
                    ...
                    window1.RTCPeerConnection.prototype.addTrack = function addTrack(track, stream) {
                        ...
                        if (oldStream) {
                            ...
                            var newStream = new window1.MediaStream([
                                track
                            ]);
                            this._streams[stream.id] = newStream;
                            this._reverseStreams[newStream.id] = stream;
                    ...
                    [
                        ...
                        var nativeMethod = window1.RTCPeerConnection.prototype[method];
                    ...
                    var origSetLocalDescription = window1.RTCPeerConnection.prototype.setLocalDescription;
                    ...
                    var origLocalDescription = Object.getOwnPropertyDescriptor(window1.RTCPeerConnection.prototype, "localDescription");
                ...
                function shimPeerConnection(window1, browserDetails) {
                    if (!window1.RTCPeerConnection && window1.webkitRTCPeerConnection) // very basic support for old versions.
                ...
                function fixNegotiationNeeded(window1, browserDetails) {
                    utils.wrapPeerConnectionEvent(window1, "negotiationneeded", function(e) {
                        var pc = e.target;
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.shimGetDisplayMedia = shimGetDisplayMedia;
                function shimGetDisplayMedia(window1, getSourceId) {
                    if (window1.navigator.mediaDevices && "getDisplayMedia" in window1.navigator.mediaDevices) return;
                    if (!window1.navigator.mediaDevices) return;
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.shimGetUserMedia = shimGetUserMedia;
                var _utils = require1("../utils.js");
                var utils = _interopRequireWildcard(_utils);
                function _interopRequireWildcard(obj) {
                    if (obj && obj.__esModule) return obj;
                ...
                var logging = utils.log;
                function shimGetUserMedia(window1, browserDetails) {
                    var navigator = window1 && window1.navigator;
                    if (!navigator.mediaDevices) return;
                    var constraintsToChrome_ = function constraintsToChrome_(c) {
                        if ((typeof c === "undefined" ? "undefined" : _typeof(c)) !== "object" || c.mandatory || c.optional) return c;
                        var cc = {};
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.shimRTCIceCandidate = shimRTCIceCandidate;
                exports1.shimMaxMessageSize = shimMaxMessageSize;
                exports1.shimSendThrowTypeError = shimSendThrowTypeError;
                exports1.shimConnectionState = shimConnectionState;
                exports1.removeExtmapAllowMixed = removeExtmapAllowMixed;
                exports1.shimAddIceCandidateNullOrEmpty = shimAddIceCandidateNullOrEmpty;
                exports1.shimParameterlessSetLocalDescription = shimParameterlessSetLocalDescription;
                var _sdp = require1("sdp");
                ...
                function shimRTCIceCandidate(window1) {
                    // foundation is arbitrarily chosen as an indicator for full support for
                    // https://w3c.github.io/webrtc-pc/#rtcicecandidate-interface
                    if (!window1.RTCIceCandidate || window1.RTCIceCandidate && "foundation" in window1.RTCIceCandidate.prototype) return;
                    var NativeRTCIceCandidate = window1.RTCIceCandidate;
                    window1.RTCIceCandidate = function RTCIceCandidate(args) {
                    ...
                    utils.wrapPeerConnectionEvent(window1, "icecandidate", function(e) {
                ...
                function shimMaxMessageSize(window1, browserDetails) {
                    if (!window1.RTCPeerConnection) return;
                    if (!("sctp" in window1.RTCPeerConnection.prototype)) Object.defineProperty(window1.RTCPeerConnection.prototype, "sctp", {
                        get: function get() {
                ...
                function shimSendThrowTypeError(window1) {
                    if (!(window1.RTCPeerConnection && "createDataChannel" in window1.RTCPeerConnection.prototype)) return;
                    ...
                    var origCreateDataChannel = window1.RTCPeerConnection.prototype.createDataChannel;
                    window1.RTCPeerConnection.prototype.createDataChannel = function createDataChannel() {
                        var dataChannel = origCreateDataChannel.apply(this, arguments);
                        wrapDcSend(dataChannel, this);
                        return dataChannel;
                    };
                    utils.wrapPeerConnectionEvent(window1, "datachannel", function(e) {
 ...
 */ function shimConnectionState(window1) {
                    if (!window1.RTCPeerConnection || "connectionState" in window1.RTCPeerConnection.prototype) return;
                ...
                function removeExtmapAllowMixed(window1, browserDetails) {
                    /* remove a=extmap-allow-mixed for webrtc.org < M71 */ if (!window1.RTCPeerConnection) return;
                    ...
                    var nativeSRD = window1.RTCPeerConnection.prototype.setRemoteDescription;
                    window1.RTCPeerConnection.prototype.setRemoteDescription = function setRemoteDescription(desc) {
                        if (desc && desc.sdp && desc.sdp.indexOf("\na=extmap-allow-mixed") !== -1) {
                            ...
                            if (window1.RTCSessionDescription && desc instanceof window1.RTCSessionDescription) arguments[0] = new window1.RTCSessionDescription({
                                type: desc.type,
                                sdp: sdp
                            });
                            else desc.sdp = sdp;
                ...
                function shimAddIceCandidateNullOrEmpty(window1, browserDetails) {
                    ...
                    if (!(window1.RTCPeerConnection && window1.RTCPeerConnection.prototype)) return;
                    var nativeAddIceCandidate = window1.RTCPeerConnection.prototype.addIceCandidate;
                ...
                function shimParameterlessSetLocalDescription(window1, browserDetails) {
                    if (!(window1.RTCPeerConnection && window1.RTCPeerConnection.prototype)) return;
                    var nativeSetLocalDescription = window1.RTCPeerConnection.prototype.setLocalDescription;
                    if (!nativeSetLocalDescription || nativeSetLocalDescription.length === 0) return;
                    window1.RTCPeerConnection.prototype.setLocalDescription = function setLocalDescription() {
                        var _this = this;
                        var desc = arguments[0] || {};
                        if ((typeof desc === "undefined" ? "undefined" : _typeof(desc)) !== "object" || desc.type && desc.sdp) return nativeSetLocalDescription.apply(this, arguments);
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.shimOnTrack = shimOnTrack;
                exports1.shimPeerConnection = shimPeerConnection;
                exports1.shimSenderGetStats = shimSenderGetStats;
                exports1.shimReceiverGetStats = shimReceiverGetStats;
                exports1.shimRemoveStream = shimRemoveStream;
                exports1.shimRTCDataChannel = shimRTCDataChannel;
                exports1.shimAddTransceiver = shimAddTransceiver;
                exports1.shimGetParameters = shimGetParameters;
                exports1.shimCreateOffer = shimCreateOffer;
                exports1.shimCreateAnswer = shimCreateAnswer;
                var _utils = require1("../utils");
                var utils = _interopRequireWildcard(_utils);
                function _interopRequireWildcard(obj) {
                    if (obj && obj.__esModule) return obj;
                ...
                function shimOnTrack(window1) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCTrackEvent && "receiver" in window1.RTCTrackEvent.prototype && !("transceiver" in window1.RTCTrackEvent.prototype)) Object.defineProperty(window1.RTCTrackEvent.prototype, "transceiver", {
                        get: function get() {
                            return {
                ...
                function shimPeerConnection(window1, browserDetails) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) !== "object" || !(window1.RTCPeerConnection || window1.mozRTCPeerConnection)) return; // probably media.peerconnection.enabled=false in about:config
                    if (!window1.RTCPeerConnection && window1.mozRTCPeerConnection) // very basic support for old versions.
                    ...
                    var nativeGetStats = window1.RTCPeerConnection.prototype.getStats;
                    window1.RTCPeerConnection.prototype.getStats = function getStats() {
                        var _arguments = Array.prototype.slice.call(arguments), selector = _arguments[0], onSucc = _arguments[1], onErr = _arguments[2];
                ...
                function shimSenderGetStats(window1) {
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection && window1.RTCRtpSender)) return;
                    if (window1.RTCRtpSender && "getStats" in window1.RTCRtpSender.prototype) return;
                    var origGetSenders = window1.RTCPeerConnection.prototype.getSenders;
                    if (origGetSenders) window1.RTCPeerConnection.prototype.getSenders = function getSenders() {
                        var _this = this;
                        var senders = origGetSenders.apply(this, []);
                ...
                function shimReceiverGetStats(window1) {
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection && window1.RTCRtpSender)) return;
                    if (window1.RTCRtpSender && "getStats" in window1.RTCRtpReceiver.prototype) return;
                    var origGetReceivers = window1.RTCPeerConnection.prototype.getReceivers;
                    if (origGetReceivers) window1.RTCPeerConnection.prototype.getReceivers = function getReceivers() {
                        var _this2 = this;
                        var receivers = origGetReceivers.apply(this, []);
                ...
                function shimRemoveStream(window1) {
                    if (!window1.RTCPeerConnection || "removeStream" in window1.RTCPeerConnection.prototype) return;
                    window1.RTCPeerConnection.prototype.removeStream = function removeStream(stream) {
                        var _this3 = this;
                ...
                function shimRTCDataChannel(window1) {
                    ...
                    if (window1.DataChannel && !window1.RTCDataChannel) window1.RTCDataChannel = window1.DataChannel;
                }
                function shimAddTransceiver(window1) {
                    // https://github.com/webrtcHacks/adapter/issues/998#issuecomment-516921647
                    // Firefox ignores the init sendEncodings options passed to addTransceiver
                    // https://bugzilla.mozilla.org/show_bug.cgi?id=1396918
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection)) return;
                    var origAddTransceiver = window1.RTCPeerConnection.prototype.addTransceiver;
                    if (origAddTransceiver) window1.RTCPeerConnection.prototype.addTransceiver = function addTransceiver() {
                ...
                function shimGetParameters(window1) {
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCRtpSender)) return;
                    var origGetParameters = window1.RTCRtpSender.prototype.getParameters;
                    if (origGetParameters) window1.RTCRtpSender.prototype.getParameters = function getParameters() {
                ...
                function shimCreateOffer(window1) {
                    ...
                    // https://bugzilla.mozilla.org/show_bug.cgi?id=1396918
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection)) return;
                    var origCreateOffer = window1.RTCPeerConnection.prototype.createOffer;
                ...
                function shimCreateAnswer(window1) {
                    ...
                    // https://bugzilla.mozilla.org/show_bug.cgi?id=1396918
                    if (!((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) === "object" && window1.RTCPeerConnection)) return;
                    var origCreateAnswer = window1.RTCPeerConnection.prototype.createAnswer;
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.shimGetDisplayMedia = shimGetDisplayMedia;
                function shimGetDisplayMedia(window1, preferredMediaSource) {
                    if (window1.navigator.mediaDevices && "getDisplayMedia" in window1.navigator.mediaDevices) return;
                    if (!window1.navigator.mediaDevices) return;
                    window1.navigator.mediaDevices.getDisplayMedia = function getDisplayMedia(constraints) {
 ...
 */ /* eslint-env node */ "use strict";
                ...
                function shimGetUserMedia(window1, browserDetails) {
                    var navigator = window1 && window1.navigator;
                    var MediaStreamTrack = window1 && window1.MediaStreamTrack;
 ...
 */ "use strict";
                ...
                exports1.shimLocalStreamsAPI = shimLocalStreamsAPI;
                exports1.shimRemoteStreamsAPI = shimRemoteStreamsAPI;
                exports1.shimCallbacksAPI = shimCallbacksAPI;
                exports1.shimGetUserMedia = shimGetUserMedia;
                exports1.shimConstraints = shimConstraints;
                exports1.shimRTCIceServerUrls = shimRTCIceServerUrls;
                exports1.shimTrackEventTransceiver = shimTrackEventTransceiver;
                exports1.shimCreateOfferLegacy = shimCreateOfferLegacy;
                exports1.shimAudioContext = shimAudioContext;
                var _utils = require1("../utils");
                var utils = _interopRequireWildcard(_utils);
                function _interopRequireWildcard(obj) {
                    if (obj && obj.__esModule) return obj;
                ...
                function shimLocalStreamsAPI(window1) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) !== "object" || !window1.RTCPeerConnection) return;
                    if (!("getLocalStreams" in window1.RTCPeerConnection.prototype)) window1.RTCPeerConnection.prototype.getLocalStreams = function getLocalStreams() {
                        if (!this._localStreams) this._localStreams = [];
                        return this._localStreams;
                    };
                    if (!("addStream" in window1.RTCPeerConnection.prototype)) {
                        var _addTrack = window1.RTCPeerConnection.prototype.addTrack;
                        window1.RTCPeerConnection.prototype.addStream = function addStream(stream) {
                            var _this = this;
                            if (!this._localStreams) this._localStreams = [];
                        ...
                        window1.RTCPeerConnection.prototype.addTrack = function addTrack(track) {
                            var _this2 = this;
                            for(var _len = arguments.length, streams = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++)streams[_key - 1] = arguments[_key];
                    ...
                    if (!("removeStream" in window1.RTCPeerConnection.prototype)) window1.RTCPeerConnection.prototype.removeStream = function removeStream(stream) {
                        var _this3 = this;
                        if (!this._localStreams) this._localStreams = [];
                ...
                function shimRemoteStreamsAPI(window1) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) !== "object" || !window1.RTCPeerConnection) return;
                    if (!("getRemoteStreams" in window1.RTCPeerConnection.prototype)) window1.RTCPeerConnection.prototype.getRemoteStreams = function getRemoteStreams() {
                ...
                function shimCallbacksAPI(window1) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) !== "object" || !window1.RTCPeerConnection) return;
                    var prototype = window1.RTCPeerConnection.prototype;
                ...
                function shimRTCIceServerUrls(window1) {
                    ...
                    var OrigPeerConnection = window1.RTCPeerConnection;
                    window1.RTCPeerConnection = function RTCPeerConnection(pcConfig, pcConstraints) {
                    ...
                    if ("generateCertificate" in OrigPeerConnection) Object.defineProperty(window1.RTCPeerConnection, "generateCertificate", {
                        get: function get() {
                ...
                function shimAudioContext(window1) {
                    if ((typeof window1 === "undefined" ? "undefined" : _typeof(window1)) !== "object" || window1.AudioContext) return;
 ...
 */ /* eslint-env node */ "use strict";
                ...
                exports1.extractVersion = extractVersion;
                exports1.wrapPeerConnectionEvent = wrapPeerConnectionEvent;
                exports1.disableLog = disableLog;
                exports1.disableWarnings = disableWarnings;
                exports1.log = log;
                exports1.deprecated = deprecated;
                exports1.detectBrowser = detectBrowser;
                exports1.compactObject = compactObject;
                exports1.walkStats = walkStats;
                exports1.filterStats = filterStats;
                function _defineProperty(obj, key, value) {
                    if (key in obj) Object.defineProperty(obj, key, {
                        value: value,
                        enumerable: true,
 ...
 */ function extractVersion(uastring, expr, pos) {
                ...
                function disableLog(bool) {
                    if (typeof bool !== "boolean") return new Error("Argument type: " + (typeof bool === "undefined" ? "undefined" : _typeof(bool)) + ". Please use a boolean.");
                    logDisabled_ = bool;
 ...
 */ function compactObject(data) {
        ...
        12: [
            function(require1, module1, exports1) {
                ...
                if ((typeof module1 === "undefined" ? "undefined" : _typeof(module1)) === "object") module1.exports = SDPUtils;
            },
            {}
        ]
    }, {}, [
...
//# sourceMappingURL=webTRC.76dc5ef7.js.map
