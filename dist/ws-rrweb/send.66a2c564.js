var rrweb = function(ee) {
    ...
    function Jn(t) {
        ...
        for(var n = 50, r = 0; r < t.width; r += n)for(var o = 0; o < t.height; o += n){
            var a = e.getImageData, s = Dt in a ? a[Dt] : a, i = new Uint32Array(s.call(e, r, o, Math.min(n, t.width - r), Math.min(n, t.height - o)).data.buffer);
    ...
    var we, xt, or = /url\((?:(')([^']*)'|(")(.*?)"|([^)]*))\)/gm, sr = /^(?!www\.|(?:http|ftp)s?:\/\/|[A-Za-z]:\\|\/\/|#).*/, ir = /^(data:)([^,]*),(.*)/i;
    function Ve(t, e) {
    ...
    function cr(t, e) {
        ...
        for(var o = []; r(lr), !(n >= e.length);){
            var a = r(ar);
            if (a.slice(-1) === ",") a = Be(t, a.substring(0, a.length - 1)), o.push(a);
            else {
                var s = "";
                a = Be(t, a);
                for(var i = !1;;){
    ...
    function mr(t, e) {
        var n = e.doc, r = e.mirror, o = e.blockClass, a = e.blockSelector, s = e.maskTextClass, i = e.maskTextSelector, l = e.inlineStylesheet, c = e.maskInputOptions, u = c === void 0 ? {} : c, d = e.maskTextFn, h = e.maskInputFn, p = e.dataURLOptions, m = p === void 0 ? {} : p, b = e.inlineImages, S = e.recordCanvas, f = e.keepIframeSrcFn, y = e.newlyAddedElement, g = y === void 0 ? !1 : y, E = fr(n, r);
        switch(t.nodeType){
    ...
    function yr(t, e) {
        var n, r = e.maskTextClass, o = e.maskTextSelector, a = e.maskTextFn, s = e.rootId, i = t.parentNode && t.parentNode.tagName, l = t.textContent, c = i === "STYLE" ? !0 : void 0, u = i === "SCRIPT" ? !0 : void 0;
        if (c && l) {
            try {
    ...
    function gr(t, e) {
        ...
        if (y === "option" && (t.selected && !i.select ? g.selected = !0 : delete g.selected), y === "canvas" && h) {
            if (t.__context === "2d") Jn(t) || (g.rr_dataURL = t.toDataURL(u.type, u.quality));
    ...
    function Ee(t, e) {
        var n = e.doc, r = e.mirror, o = e.blockClass, a = e.blockSelector, s = e.maskTextClass, i = e.maskTextSelector, l = e.skipChild, c = l === void 0 ? !1 : l, u = e.inlineStylesheet, d = u === void 0 ? !0 : u, h = e.maskInputOptions, p = h === void 0 ? {} : h, m = e.maskTextFn, b = e.maskInputFn, S = e.slimDOMOptions, f = e.dataURLOptions, y = f === void 0 ? {} : f, g = e.inlineImages, E = g === void 0 ? !1 : g, k = e.recordCanvas, x = k === void 0 ? !1 : k, F = e.onSerialize, _ = e.onIframeLoad, J = e.iframeLoadTimeout, Y = J === void 0 ? 5e3 : J, q = e.onStylesheetLoad, z = e.stylesheetLoadTimeout, X = z === void 0 ? 5e3 : z, $ = e.keepIframeSrcFn, Z = $ === void 0 ? function() {
            return !1;
        } : $, H = e.newlyAddedElement, L = H === void 0 ? !1 : H, te = e.preserveWhiteSpace, w = te === void 0 ? !0 : te, v = mr(t, {
            doc: n,
            mirror: r,
            blockClass: o,
            blockSelector: a,
...
`);
        ...
        function l(w) {
            ...
            if (v.reason = w, v.filename = e.source, v.line = n, v.column = r, v.source = t, e.silent) i.push(v);
            else throw v;
        }
        function c() {
            var w = h();
        ...
        function S() {
            ...
            if (!(t.charAt(0) !== "/" || t.charAt(1) !== "*")) {
                ...
                var M = t.slice(2, v - 2);
                return r += 2, o(M), t = t.slice(v), r += 2, w({
                    type: "comment",
                    comment: M
                });
            }
            ...
            case D.Element:
                ...
                for(var l in t.attributes)if (Object.prototype.hasOwnProperty.call(t.attributes, l)) {
                    ...
                    if (!(a === "option" && l === "selected" && c === !1)) {
                        ...
                        try {
                            if (t.isSVG && l === "xlink:href") s.setAttributeNS("http://www.w3.org/1999/xlink", l, c.toString());
                            else if (l === "onload" || l === "onclick" || l.substring(0, 7) === "onmouse") s.setAttribute("_" + l, c.toString());
                ...
                var S = function(y) {
                    ...
                    else if (y === "rr_mediaCurrentTime" && typeof g == "number") s.currentTime = g;
                    else if (y === "rr_mediaState") switch(g){
                        case "played":
                ...
                for(var f in i)S(f);
                if (t.isShadowHost) {
                    if (!s.shadowRoot) s.attachShadow({
                        mode: "open"
                    });
                    else for(; s.shadowRoot.firstChild;)s.shadowRoot.removeChild(s.shadowRoot.firstChild);
                }
                return s;
            case D.Text:
    ...
    function _e(t, e) {
        var n = e.doc, r = e.mirror, o = e.skipChild, a = o === void 0 ? !1 : o, s = e.hackCss, i = s === void 0 ? !0 : s, l = e.afterAppend, c = e.cache, u = Cr(t, {
            doc: n,
            hackCss: i,
            cache: c
        });
    ...
    function Mr(t, e) {
        var n = e.doc, r = e.onVisit, o = e.hackCss, a = o === void 0 ? !0 : o, s = e.afterAppend, i = e.cache, l = e.mirror, c = l === void 0 ? new qe : l, u = _e(t, {
            doc: n,
            mirror: c,
            skipChild: !1,
            hackCss: a,
...
or you can use record.mirror to access the mirror instance during recording.`;
        ...
        for (const o of t){
            ...
            if (a && a in e) {
                ...
                if (i.parent) {
                    ...
                    const l1 = r.indexOf(i);
                    r.splice(l1, 0, n(o, null));
                }
                continue;
            }
            if (s in e) {
                const i1 = e[s];
                i1.children.push(n(o, i1));
                continue;
            }
            r.push(n(o, null));
        }
    ...
    class Dr {
        ...
        addNode(e) {
            ...
            if (e.__ln = n, e.previousSibling && Bt(e.previousSibling)) {
                ...
                const r1 = e.nextSibling.__ln.previous;
                n.previous = r1, n.next = e.nextSibling.__ln, e.nextSibling.__ln.previous = n, r1 && (r1.next = n);
    ...
    class Rr {
        constructor(){
            this.frozen = !1, this.locked = !1, this.texts = [], this.attributes = [], this.removes = [], this.mapRemoves = [], this.movedMap = {}, this.addedSet = new Set, this.movedSet = new Set, this.droppedSet = new Set, this.processMutations = (e)=>{
                ...
                for (const i1 of Array.from(this.addedSet.values()))!Ht(this.droppedSet, i1) && !jt(this.removes, i1, this.mirror) || Ht(this.movedSet, i1) ? o(i1) : this.droppedSet.add(i1);
                let a = null;
                for(; n.length;){
                    let i2 = null;
                    if (a) {
                    ...
                    if (!i2) for(let l1 = n.length - 1; l1 >= 0; l1--){
                        const c1 = n.get(l1);
                        if (c1) {
                            const u = this.mirror.getId(c1.value.parentNode);
                            if (r(c1.value) === -1) continue;
                            if (u !== -1) {
                                i2 = c1;
                                break;
                            } else {
                    ...
                    a = i2.previous, n.removeNode(i2.value), o(i2.value);
                }
                const s = {
                    ...
                    case "attributes":
                        {
                            ...
                            if (n1.tagName === "IFRAME" && e.attributeName === "src" && !this.keepIframeSrcFn(r)) {
                                if (!n1.contentDocument) e.attributeName = "rr_src";
                                else return;
                            }
                            if (o || (o = {
                                node: e.target,
                                ...
                                for (const i of Array.from(n1.style)){
                                    const l = n1.style.getPropertyValue(i), c = n1.style.getPropertyPriority(i);
                                    (l !== a.style.getPropertyValue(i) || c !== a.style.getPropertyPriority(i)) && (c === "" ? s[i] = l : s[i] = [
                                        l,
                                        c
                                    ]);
                                }
                                for (const i1 of Array.from(a.style))n1.style.getPropertyValue(i1) === "" && (s[i1] = !1);
                            } else o.attributes[e.attributeName] = Ot(this.doc, n1.tagName, e.attributeName, r);
                            break;
                        }
                    case "childList":
                        ...
                        e.addedNodes.forEach((n)=>this.genAdds(n, e.target)), e.removedNodes.forEach((n)=>{
                            const r = this.mirror.getId(n), o = Oe(e.target) ? this.mirror.getId(e.target.host) : this.mirror.getId(e.target);
    ...
    var xr = Object.defineProperty, Or = Object.defineProperties, Lr = Object.getOwnPropertyDescriptors, Xt = Object.getOwnPropertySymbols, Ar = Object.prototype.hasOwnProperty, _r = Object.prototype.propertyIsEnumerable, Zt = (t, e, n)=>e in t ? xr(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
    ...
    const Se = [], Qt = typeof CSSGroupingRule < "u", Jt = typeof CSSMediaRule < "u", qt = typeof CSSSupportsRule < "u", en = typeof CSSConditionRule < "u";
    function Pe(t) {
        try {
    ...
    function Pr({ mousemoveCb: t , sampling: e , doc: n , mirror: r  }) {
        ...
        const o = typeof e.mousemove == "number" ? e.mousemove : 50, a = typeof e.mousemoveCallback == "number" ? e.mousemoveCallback : 500;
        let s = [], i;
        const l = Ce((d)=>{
            const h = Date.now() - i;
    ...
    function Wr({ mouseInteractionCb: t , doc: e , mirror: n , blockClass: r , blockSelector: o , sampling: a  }) {
        ...
        const s = a.mouseInteraction === !0 || a.mouseInteraction === void 0 ? {} : a.mouseInteraction, i = [], l = (c)=>(u)=>{
                const d = Pe(u);
                if (Q(d, r, o, !0)) return;
    ...
    function Vr({ inputCb: t , doc: e , mirror: n , blockClass: r , blockSelector: o , ignoreClass: a , maskInputOptions: s , maskInputFn: i , sampling: l , userTriggeredOnInput: c  }) {
        function u(S) {
            let f = Pe(S);
            const y = S.isTrusted;
        ...
        const h = (l.input === "last" ? [
            "change"
        ] : [
            "input",
            "change"
        ]).map((S)=>K(S, u, e)), p = e.defaultView;
        if (!p) return ()=>{
            h.forEach((S)=>S());
        };
        const m = p.Object.getOwnPropertyDescriptor(p.HTMLInputElement.prototype, "value"), b = [
            [
    ...
    function ze(t) {
        ...
        function n(r, o) {
            if (Qt && r.parentRule instanceof CSSGroupingRule || Jt && r.parentRule instanceof CSSMediaRule || qt && r.parentRule instanceof CSSSupportsRule || en && r.parentRule instanceof CSSConditionRule) {
                ...
                const a1 = Array.from(r.parentStyleSheet.cssRules).indexOf(r);
                o.unshift(a1);
            }
            return o;
        }
    ...
    function sn({ mirror: t , stylesheetManager: e  }, n) {
        ...
        const i = n.nodeName === "#document" ? (r = n.defaultView) == null ? void 0 : r.Document : (a = (o = n.ownerDocument) == null ? void 0 : o.defaultView) == null ? void 0 : a.ShadowRoot, l = Object.getOwnPropertyDescriptor(i?.prototype, "adoptedStyleSheets");
        return s === null || s === -1 || !i || !l ? ()=>{} : (Object.defineProperty(n, "adoptedStyleSheets", {
    ...
    function Gr({ styleDeclarationCb: t , mirror: e , ignoreCSSAttributes: n , stylesheetManager: r  }, { win: o  }) {
        ...
        o.CSSStyleDeclaration.prototype.setProperty = function(i, l, c) {
            var u;
            if (n.has(i)) return a.apply(this, [
                i,
                l,
                c
            ]);
            const { id: d , styleId: h  } = fe((u = this.parentRule) == null ? void 0 : u.parentStyleSheet, e, r.styleMirror);
            return (d && d !== -1 || h && h !== -1) && t({
                id: d,
                styleId: h,
                set: {
        ...
        return o.CSSStyleDeclaration.prototype.removeProperty = function(i) {
            var l;
            if (n.has(i)) return s.apply(this, [
                i
            ]);
            const { id: c , styleId: u  } = fe((l = this.parentRule) == null ? void 0 : l.parentStyleSheet, e, r.styleMirror);
    ...
    function Yr(t, e) {
        const { mutationCb: n , mousemoveCb: r , mouseInteractionCb: o , scrollCb: a , viewportResizeCb: s , inputCb: i , mediaInteractionCb: l , styleSheetRuleCb: c , styleDeclarationCb: u , canvasMutationCb: d , fontCb: h , selectionCb: p  } = t;
        t.mutationCb = (...m)=>{
    ...
    function Xr(t, e = {}) {
        ...
        if (!n) return ()=>{};
        Yr(t, e);
        const r = tn(t, t.doc), o = Pr(t), a = Wr(t), s = nn(t), i = $r(t), l = Vr(t), c = jr(t), u = Br(t, {
            win: n
        }), d = sn(t, t.doc), h = Gr(t, {
            win: n
        }), p = t.collectFonts ? zr(t) : ()=>{}, m = Hr(t), b = [];
    ...
    class Zr {
        ...
        transformCrossOriginEvent(e, n) {
            ...
            switch(n.type){
                ...
                case C.Plugin:
                    return n;
                case C.Custom:
                    return this.replaceIds(n.data.payload, e, [
                        "id",
                        "parentId",
                        "previousId",
                        "nextId"
                ...
                case C.IncrementalSnapshot:
                    switch(n.data.source){
                        ...
                        case N.Input:
                            return this.replaceIds(n.data, e, [
                                "id"
                            ]), n;
                        ...
                        case N.AdoptedStyleSheet:
                            return this.replaceIds(n.data, e, [
                                ...
                                "styleIds"
                            ]), (r = n.data.styles) == null || r.forEach((o)=>{
                                this.replaceStyleIds(o, e, [
                                    "styleId"
                                ]);
                            }), n;
                    }
        ...
        replaceIdOnNode(e, n) {
            this.replaceIds(e, n, [
                "id"
            ]), "childNodes" in e && e.childNodes.forEach((r)=>{
                this.replaceIdOnNode(r, n);
            });
        }
    }
    var Kr = Object.defineProperty, Qr = Object.defineProperties, Jr = Object.getOwnPropertyDescriptors, ln = Object.getOwnPropertySymbols, qr = Object.prototype.hasOwnProperty, eo = Object.prototype.propertyIsEnumerable, cn = (t, e, n)=>e in t ? Kr(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
    ...
    function Ye(t, e, n) {
        ...
        if (t instanceof ArrayBuffer) {
            ...
            if (t instanceof HTMLImageElement) {
                const r1 = t.constructor.name, { src: o1  } = t;
                return {
                    rr_type: r1,
                    src: o1
                };
            } else if (t instanceof HTMLCanvasElement) {
                const r2 = "HTMLImageElement", o2 = t.toDataURL();
                return {
                    rr_type: r2,
                    src: o2
                };
                ...
                if (fn(t, e) || typeof t == "object") {
                    const r3 = t.constructor.name, o3 = pn(t, e, n);
                    return {
                        rr_type: r3,
                        index: o3
                    };
    ...
    function yn(t, e, n) {
        ...
        try {
            const o = ge(t.HTMLCanvasElement.prototype, "getContext", function(a) {
                return function(s, ...i) {
                    return Q(this, e, n, !0) || "__context" in this || (this.__context = s), a.apply(this, [
                        s,
                        ...i
                    ]);
                };
...
`, 10) + 1, i = a.substring(s) + (r ? "//# sourceMappingURL=" + r : ""), l = new Blob([
            i
        ], {
    ...
    class yo {
        constructor(e){
            ...
            const { sampling: n = "all" , win: r , blockClass: o , blockSelector: a , recordCanvas: s , dataURLOptions: i  } = e;
            this.mutationCb = e.mutationCb, this.mirror = e.mirror, s && n === "all" && this.initCanvasMutationObserver(r, o, a), s && typeof n == "number" && this.initCanvasFPSObserver(n, r, o, a, {
                dataURLOptions: i
            });
        }
        reset() {
        ...
        initCanvasMutationObserver(e, n, r) {
            ...
            const o = yn(e, n, r), a = so(this.processMutation.bind(this), e, n, r), s = io(this.processMutation.bind(this), e, n, r, this.mirror);
            this.resetObservers = ()=>{
                o(), a(), s();
            };
        }
    ...
    var vo = Object.defineProperty, So = Object.defineProperties, bo = Object.getOwnPropertyDescriptors, Sn = Object.getOwnPropertySymbols, wo = Object.prototype.hasOwnProperty, Eo = Object.prototype.propertyIsEnumerable, bn = (t, e, n)=>e in t ? vo(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
    ...
    const le = kt();
    function be(t = {}) {
        const { emit: e , checkoutEveryNms: n , checkoutEveryNth: r , blockClass: o = "rr-block" , blockSelector: a = null , ignoreClass: s = "rr-ignore" , maskTextClass: i = "rr-mask" , maskTextSelector: l = null , inlineStylesheet: c = !0 , maskAllInputs: u , maskInputOptions: d , slimDOMOptions: h , maskInputFn: p , maskTextFn: m , hooks: b , packFn: S , sampling: f = {} , dataURLOptions: y = {} , mousemoveWait: g , recordCanvas: E = !1 , recordCrossOriginIframes: k = !1 , userTriggeredOnInput: x = !1 , collectFonts: F = !1 , inlineImages: _ = !1 , plugins: J , keepIframeSrcFn: Y = ()=>!1 , ignoreCSSAttributes: q = new Set([])  } = t, z = k ? window.parent === window : !0;
        let X = !1;
        if (!z) try {
        ...
        V = (I, oe)=>{
            var ae;
            if (((ae = Se[0]) == null ? void 0 : ae.isFrozen()) && I.type !== C.FullSnapshot && !(I.type === C.IncrementalSnapshot && I.data.source === N.Mutation) && Se.forEach((B)=>B.unfreeze()), z) e?.(te(I), oe);
            else if (X) {
                const B = {
                    type: "rrweb",
                    event: te(I),
            ...
            if (I.type === C.FullSnapshot) H = I, L = 0;
                ...
                L++;
                const B1 = r && L >= r, ue = n && I.timestamp - H.timestamp > n;
                (B1 || ue) && Xe(!0);
            }
        };
        const w = (I)=>{
            V(G({
                ...
                type: C.IncrementalSnapshot,
                data: se({
                    source: N.CanvasMutation
                }, I)
            })), T = (I)=>V(G({
                type: C.IncrementalSnapshot,
                data: se({
                    source: N.AdoptedStyleSheet
                }, I)
            })), W = new go({
            mutationCb: w,
        ...
        try {
            ...
            ne.addLoadListener((B)=>{
                I1.push(oe(B.contentDocument));
            });
            const ae = ()=>{
                Xe(), I1.push(oe(document)), Ze = !0;
            };
            return document.readyState === "interactive" || document.readyState === "complete" ? ae() : I1.push(K("load", ()=>{
                V(G({
                    type: C.Load,
                    data: {}
                })), ae();
    ...
    const Mo = /-([a-z])/g, ko = /^--[a-zA-Z0-9-]+$/, ft = (t)=>ko.test(t) ? t : t.replace(Mo, (e, n)=>n ? n.toUpperCase() : ""), Do = /\B([A-Z])/g, Ro = (t)=>t.replace(Do, "-$1").toLowerCase();
    class ce {
        constructor(...e){
    ...
    function de(t, e, n, r) {
            ...
            case R.Element:
                {
                    ...
                    switch(_o(l, c, r), i = c.scrollData, s = c.inputData, c.tagName){
                        ...
                        case "CANVAS":
                            {
                                const u1 = e;
                                if (u1.rr_dataURL !== null) {
                                    const d1 = document.createElement("img");
                                    d1.onload = ()=>{
                                        const h = l.getContext("2d");
                                        h && h.drawImage(d1, 0, 0, d1.width, d1.height);
                                    }, d1.src = u1.rr_dataURL;
                                }
                                u1.canvasMutations.forEach((d)=>n.applyCanvas(d.event, d.mutation, t));
                            }
                            break;
                        case "STYLE":
                            {
                                const u2 = l.sheet;
                                u2 && e.rules.forEach((d)=>n.applyStyleSheetMutation(d, u2));
                            }
                            break;
                    }
                    if (c.shadowRoot) {
                        ...
                        const u3 = l.shadowRoot.childNodes, d2 = c.shadowRoot.childNodes;
                        (u3.length > 0 || d2.length > 0) && Mn(Array.from(u3), d2, l.shadowRoot, n, r);
                    }
                    break;
                }
            case R.Text:
        ...
        if (i && n.applyScroll(i, !0), s && n.applyInput(s), e.nodeName === "IFRAME") {
            const l1 = t.contentDocument, c1 = e;
            if (l1) {
                const u4 = r.getMeta(c1.contentDocument);
                u4 && n.mirror.add(l1, Object.assign({}, u4)), de(l1, c1.contentDocument, n, r);
            }
        }
    }
    function _o(t, e, n) {
        ...
        for (const { name: a1  } of Array.from(r))a1 in o || t.removeAttribute(a1);
    ...
    function Mn(t, e, n, r, o) {
        ...
        for(; s <= i && l <= c;){
            ...
            if (u === void 0) u = t[++s];
            ...
            else if (S !== -1 && S === g) n.insertBefore(u, d.nextSibling), de(u, p, r, o), u = t[++s], p = e[--c];
            else if (f !== -1 && f === y) n.insertBefore(d, u), de(d, h, r, o), d = t[--i], h = e[++l];
            else {
                if (!m) {
                    m = {};
                    for(let E = s; E <= i; E++){
                ...
                if (b = m[o.getId(h)], b) {
                    const E1 = t[b];
                    n.insertBefore(E1, u), de(E1, h, r, o), t[b] = void 0;
                } else {
                    const E2 = gt(h, r.mirror, o);
                    n.nodeName === "#document" && ((a = r.mirror.getMeta(E2)) === null || a === void 0 ? void 0 : a.type) === R.Element && n.documentElement && (n.removeChild(n.documentElement), t[s] = void 0, u = void 0), n.insertBefore(E2, u || null), de(E2, h, r, o);
                }
                h = e[++l];
            }
        }
        if (s > i) {
            const S1 = e[c + 1];
            let f1 = null;
            for(S1 && n.childNodes.forEach((y)=>{
                r.mirror.getId(y) === o.getId(S1) && (f1 = y);
            }); l <= c; ++l){
                const y1 = gt(e[l], r.mirror, o);
                n.insertBefore(y1, f1), de(y1, e[l], r, o);
            }
        } else if (l > c) for(; s <= i; s++){
            const S2 = t[s];
            S2 && (n.removeChild(S2), r.mirror.removeNodeFromMap(S2));
        }
    }
    function gt(t, e, n) {
            ...
            case U.ELEMENT_NODE:
                {
                    ...
                    o = e.createElement(i);
                    const l = o;
                    for (const { name: c , value: u  } of Array.from(s1.attributes))l.attributes[c] = u;
                    s1.scrollLeft && (l.scrollLeft = s1.scrollLeft), s1.scrollTop && (l.scrollTop = s1.scrollTop);
                    break;
                }
            case U.TEXT_NODE:
    ...
    function zo(t, e = Io(), n = new ke) {
        function r(o, a) {
            const s = kn(o, n, e, a);
            if (s !== null) {
                if (a?.nodeName !== "IFRAME" && o.nodeType !== U.DOCUMENT_FRAGMENT_NODE && (a?.appendChild(s), s.parentNode = a, s.parentElement = a), o.nodeName === "IFRAME") {
    ...
    ***************************************************************************** */ 
    ...
    function Wn(t, e) {
        ...
        var n = On(Pn(vt(t.states[t.initial].entry).map(function(s) {
            ...
            transition: function(s, i) {
                var l, c, u = typeof s == "string" ? {
                    value: s,
                    context: t.context
                } : s, d = u.value, h = u.context, p = _n(i), m = t.states[d];
                if (m.on) {
                    ...
                    try {
                        for(var S = function(L) {
                            ...
                            var g = typeof y == "string" ? {
                                target: y
                            } : y, E = g.target, k = g.actions, x = k === void 0 ? [] : k, F = g.cond, _ = F === void 0 ? function() {
                                return !0;
    ...
    var Qo = Object.defineProperty, Jo = Object.defineProperties, qo = Object.getOwnPropertyDescriptors, Vn = Object.getOwnPropertySymbols, es = Object.prototype.hasOwnProperty, ts = Object.prototype.propertyIsEnumerable, Bn = (t, e, n)=>e in t ? Qo(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
    ...
    function rs(t, { getCastFn: e , applyEventsSynchronously: n , emitter: r  }) {
        const o = Wn({
            ...
            actions: {
                castEvent: Re({
                    lastPlayedEvent: (a, s)=>s.type === "CAST_EVENT" ? s.payload.event : a.lastPlayedEvent
                }),
                ...
                play (a) {
                    ...
                    const p = new Array;
                    for (const m1 of d)if (!(h && h < c && (m1.timestamp <= h || m1 === u))) {
                        if (m1.timestamp < c) p.push(m1);
                        else {
                            const b = e(m1, !1);
                            i.addAction({
                                doAction: ()=>{
                ...
                resetLastPlayedEvent: Re((a)=>bt(St({}, a), {
                        lastPlayedEvent: null
                    })),
                startLive: Re({
                    baselineTime: (a, s)=>(a.timer.toggleLiveMode(!0), a.timer.start(), s.type === "TO_LIVE" && s.payload.baselineTime ? s.payload.baselineTime : Date.now())
                }),
                addEvent: Re((a, s)=>{
        ...
        return (r)=>is(this, null, function*() {
                if (r && typeof r == "object" && "rr_type" in r) {
                    if (n && (n.isUnchanged = !1), r.rr_type === "ImageBitmap" && "args" in r) {
                        ...
                        const { rr_type: o1 , index: a  } = r;
                        return jn(e, o1)[a];
                    } else if ("args" in r) {
                        const { rr_type: o2 , args: a1  } = r, s = window[o2];
                        return new s(...yield Promise.all(a1.map(ye(t, e, n))));
                    } else {
                        if ("base64" in r) return ro(r.base64);
                        if ("src" in r) {
                            const o3 = t.get(r.src);
                            if (o3) return o3;
                            {
                                const a2 = new Image;
                                return a2.src = r.src, t.set(r.src, a2), a2;
                            }
                        } else if ("data" in r && r.rr_type === "Blob") {
                            const o4 = yield Promise.all(r.data.map(ye(t, e, n)));
                            return new Blob(o4, {
                                type: r.type
                            });
                        }
    ...
    function ps(t) {
        return hs(this, arguments, function*({ event: e , mutation: n , target: r , imageMap: o , errorHandler: a  }) {
            try {
                ...
                if (n.property === "drawImage" && typeof n.args[0] == "string") o.get(e), i.apply(s, n.args);
                else {
    ...
    function zn(t) {
        return ms(this, arguments, function*({ event: e , mutation: n , target: r , imageMap: o , canvasEventMap: a , errorHandler: s  }) {
            try {
                const i = a.get(e) || n, l = "commands" in i ? i.commands : [
                    i
                ];
                if ([
                    pe.WebGL,
    ...
    var fs = Object.defineProperty, ys = Object.defineProperties, gs = Object.getOwnPropertyDescriptors, Hn = Object.getOwnPropertySymbols, vs = Object.prototype.hasOwnProperty, Ss = Object.prototype.propertyIsEnumerable, Yn = (t, e, n)=>e in t ? fs(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
    ...
    const bs = 10000, ws = 5000, Es = Rn || Xo, Nt = "[replayer]", Ct = {
        duration: 500,
        lineCap: "round",
        lineWidth: 3,
        strokeStyle: "red"
    ...
    class Ns {
        constructor(e, n){
            if (this.usingVirtualDom = !1, this.virtualDom = new ke, this.mouseTail = null, this.tailPositions = [], this.emitter = Es(), this.legacy_missingNodeRetryMap = {}, this.cache = Wt(), this.imageMap = new Map, this.canvasEventMap = new Map, this.mirror = kt(), this.styleMirror = new ht, this.firstFullSnapshot = null, this.newDocumentQueue = [], this.mousePos = null, this.touchActive = null, this.lastSelectionData = null, this.constructedStyleMutations = [], this.adoptedStyleSheets = [], this.handleResize = (i)=>{
                ...
                for (const l of [
                    this.mouseTail,
                    this.iframe
                ])!l || (l.setAttribute("width", String(i.width)), l.setAttribute("height", String(i.height)));
                        ...
                        c = ()=>{
                            if (this.applyIncremental(i, l), !l && (i === this.nextUserInteractionEvent && (this.nextUserInteractionEvent = null, this.backToNormal()), this.config.skipInactive && !this.nextUserInteractionEvent)) {
                                ...
                                if (this.nextUserInteractionEvent) {
                                    const u1 = this.nextUserInteractionEvent.delay - i.delay, d = {
                                        speed: Math.min(Math.round(u1 / ws), this.config.maxSpeed)
                                    };
                ...
                return ()=>{
                    c && c();
                    for (const d of this.config.plugins || [])d.handler && d.handler(i, l, {
                        replayer: this
                    });
                    this.service.send({
                        type: "CAST_EVENT",
                    ...
                    if (i === this.service.state.context.events[u]) {
                        ...
                        i.type === C.IncrementalSnapshot && i.data.source === N.MouseMove && i.data.positions.length ? setTimeout(()=>{
                            d1();
                        }, Math.max(0, -i.data.positions[0].timeOffset + 50)) : d1();
                    }
            ...
            for (const i of this.config.plugins || [])i.getMirror && i.getMirror({
            ...
            this.emitter.on(O.Flush, ()=>{
                if (this.usingVirtualDom) {
                    ...
                    if (this.iframe.contentDocument && de(this.iframe.contentDocument, this.virtualDom, i, this.virtualDom.mirror), this.virtualDom.destroyTree(), this.usingVirtualDom = !1, Object.keys(this.legacy_missingNodeRetryMap).length) for(const l in this.legacy_missingNodeRetryMap)try {
                        const c = this.legacy_missingNodeRetryMap[l], u = gt(c.node, this.mirror, this.virtualDom.mirror);
                        de(u, c.node, i, this.virtualDom.mirror), c.node = u;
                    } catch (c1) {
                        this.config.showWarning && console.warn(c1);
                    }
            ...
            this.service = rs({
                ...
                this.emitter.emit(O.StateChange, {
                    player: i
                });
            ...
            const a = this.service.state.context.events.find((i)=>i.type === C.Meta), s = this.service.state.context.events.find((i)=>i.type === C.FullSnapshot);
            if (a) {
                const { width: i1 , height: l  } = a.data;
                setTimeout(()=>{
        ...
        pause(e) {
            var n, r;
            e === void 0 && this.service.state.matches("playing") && this.service.send({
                type: "PAUSE"
            }), typeof e == "number" && (this.play(e), this.service.send({
                type: "PAUSE"
            })), (r = (n = this.iframe.contentDocument) == null ? void 0 : n.getElementsByTagName("html")[0]) == null || r.classList.add("rrweb-paused"), this.emitter.emit(O.Pause);
        }
        resume(e = 0) {
        ...
        rebuildFullSnapshot(e, n = !1) {
            ...
            const r = [], o = (i, l)=>{
                ...
                for (const c of this.config.plugins || [])c.onBuild && c.onBuild(i, {
                    id: l,
                    replayer: this
                });
            };
            ...
            for (const { mutationInQueue: i , builtNode: l  } of r)this.attachDocumentToIframe(i, l), this.newDocumentQueue = this.newDocumentQueue.filter((c)=>c !== i);
        ...
        insertStyleRules(e, n) {
            ...
            if (this.config.pauseAnimation && o.push("html.rrweb-paused *, html.rrweb-paused *:before, html.rrweb-paused *:after { animation-play-state: paused !important; }"), this.usingVirtualDom) {
                ...
                const a1 = document.createElement("style");
                e.insertBefore(a1, n);
                for(let s = 0; s < o.length; s++)(r = a1.sheet) == null || r.insertRule(o[s], s);
            }
        }
        attachDocumentToIframe(e, n) {
            const r = this.usingVirtualDom ? this.virtualDom.mirror : this.mirror, o = [], a = (s, i)=>{
                ...
                for (const c1 of this.config.plugins || [])c1.onBuild && c1.onBuild(s, {
                    id: i,
                    replayer: this
                });
            };
            ...
            for (const { mutationInQueue: s , builtNode: i  } of o)this.attachDocumentToIframe(s, i), this.newDocumentQueue = this.newDocumentQueue.filter((l)=>l !== s);
        }
        ...
        waitForStylesheetLoad() {
            ...
            if (n) {
                ...
                }), r.size > 0 && (this.service.send({
                    type: "PAUSE"
                }), this.emitter.emit(O.LoadStylesheetStart), o = setTimeout(()=>{
        ...
        preloadAllImages() {
            return Et(this, null, function*() {
                ...
                const n = [];
                for (const r of this.service.state.context.events)r.type === C.IncrementalSnapshot && r.data.source === N.CanvasMutation && (n.push(this.deserializeAndPreloadCanvasEvents(r.data, r)), ("commands" in r.data ? r.data.commands : [
                    r.data
                ]).forEach((o)=>{
        ...
        preloadImages(e, n) {
            if (e.property === "drawImage" && typeof e.args[0] == "string" && !this.imageMap.has(n)) {
                const r = document.createElement("canvas"), o = r.getContext("2d"), a = o?.createImageData(r.width, r.height);
            ...
            return Et(this, null, function*() {
                if (!this.canvasEventMap.has(n)) {
                    ...
                    if ("commands" in e) {
                        ...
                        r.isUnchanged === !1 && this.canvasEventMap.set(n, wt(Qe({}, e), {
                            commands: o
                        }));
                    } else {
                        const o1 = yield Promise.all(e.args.map(ye(this.imageMap, null, r)));
                        r.isUnchanged === !1 && this.canvasEventMap.set(n, wt(Qe({}, e), {
                            args: o1
                        }));
                    }
        ...
        applyIncremental(e, n) {
            ...
            switch(s.source){
                ...
                case N.MouseMove:
                    if (n) {
                        const i1 = s.positions[s.positions.length - 1];
                        this.mousePos = {
                            x: i1.x,
                            y: i1.y,
                            id: i1.id,
                ...
                case N.MouseInteraction:
                    {
                        if (s.id === -1 || n) break;
                        const i2 = new Event(j[s.type].toLowerCase()), l = this.mirror.getNode(s.id);
                        if (!l) return this.debugNodeNotFound(s, s.id);
                        this.emitter.emit(O.MouseInteraction, {
                            type: s.type,
                            target: l
                        });
                ...
                case N.Scroll:
                    if (s.id === -1) break;
                    if (this.usingVirtualDom) {
                        const i3 = this.virtualDom.mirror.getNode(s.id);
                        if (!i3) return this.debugNodeNotFound(s, s.id);
                        i3.scrollData = s;
                        break;
                    }
                ...
                case N.Input:
                    if (s.id === -1) break;
                    if (this.usingVirtualDom) {
                        const i4 = this.virtualDom.mirror.getNode(s.id);
                        if (!i4) return this.debugNodeNotFound(s, s.id);
                        i4.inputData = s;
                        break;
                    }
                    this.applyInput(s);
                ...
                case N.MediaInteraction:
                    {
                        const i5 = this.usingVirtualDom ? this.virtualDom.mirror.getNode(s.id) : this.mirror.getNode(s.id);
                        if (!i5) return this.debugNodeNotFound(s, s.id);
                        const l1 = i5;
                        try {
                            s.currentTime && (l1.currentTime = s.currentTime), s.volume && (l1.volume = s.volume), s.muted && (l1.muted = s.muted), s.type === me.Pause && l1.pause(), s.type === me.Play && l1.play(), s.type === me.RateChange && (l1.playbackRate = s.playbackRate);
                        } catch (c1) {
                            this.config.showWarning && console.warn(`Failed to replay media interactions: ${c1.message || c1}`);
                        }
                        break;
                    }
                case N.StyleSheetRule:
                ...
                case N.CanvasMutation:
                    ...
                    if (this.usingVirtualDom) {
                        const i6 = this.virtualDom.mirror.getNode(s.id);
                        if (!i6) return this.debugNodeNotFound(s, s.id);
                        i6.canvasMutations.push({
                            event: e,
                            mutation: s
                        });
                    } else {
                        const i7 = this.mirror.getNode(s.id);
                        if (!i7) return this.debugNodeNotFound(s, s.id);
                        zn({
                            event: e,
                            mutation: s,
                            target: i7,
                ...
                case N.Font:
                    try {
                        const i8 = new FontFace(s.family, s.buffer ? new Uint8Array(JSON.parse(s.fontSource)) : s.fontSource, s.descriptors);
                        (a = this.iframe.contentDocument) == null || a.fonts.add(i8);
                    } catch (i9) {
                        this.config.showWarning && console.warn(i9);
                    }
                    break;
                case N.Selection:
                    if (n) {
        ...
        applyMutation(e, n) {
            if (this.config.useVirtualDom && !this.usingVirtualDom && n && (this.usingVirtualDom = !0, zo(this.iframe.contentDocument, this.mirror, this.virtualDom), Object.keys(this.legacy_missingNodeRetryMap).length)) for(const c in this.legacy_missingNodeRetryMap)try {
                ...
                this.config.showWarning && console.warn(u1);
            }
            ...
            e.removes.forEach((c)=>{
                ...
                if (c.isShadow && ve(h) && (h = h.shadowRoot), r.removeNodeFromMap(d), h) try {
                    ...
                    if (p instanceof DOMException) this.warn("parent could not remove child in mutation", h, d, e);
                    else throw p;
                }
            });
            const o = Qe({}, this.legacy_missingNodeRetryMap), a = [], s = (c)=>{
                ...
                c.node.isShadow && (ve(d) || d.attachShadow({
                    mode: "open"
                }), d = d.shadowRoot);
                let h = null, p = null;
                ...
                const b = (y, g)=>{
                    for (const E of this.config.plugins || [])E.onBuild && E.onBuild(y, {
                        id: g,
                        replayer: this
                    });
                }, S = _e(c.node, {
                ...
                if (h && h.nextSibling && h.nextSibling.parentNode) d.insertBefore(S, h.nextSibling);
                else if (p && p.parentNode) d.contains(p) ? d.insertBefore(S, p) : d.insertBefore(S, null);
                else {
                ...
                if (b(S, c.node.id), this.usingVirtualDom && S.nodeName === "#text" && d.nodeName === "STYLE" && ((u = d.rules) == null ? void 0 : u.length) > 0 && (d.rules = []), Ie(S, this.mirror)) {
                    const y1 = this.mirror.getId(S), g1 = this.newDocumentQueue.find((E)=>E.parentId === y1);
                    g1 && (this.attachDocumentToIframe(g1, S), this.newDocumentQueue = this.newDocumentQueue.filter((E)=>E !== g1));
                }
            ...
            for(; a.length;){
                ...
                if (a.length = 0, Date.now() - l > 500) {
                    this.warn("Timeout in the loop, please check the resolve tree data:", c1);
                    break;
                }
                for (const u2 of c1)r.getNode(u2.value.parentId) ? lt(u2, (d)=>{
                    i(d);
                }) : this.debug("Drop resolve tree since there is no parent for the root node.", u2);
            }
            Object.keys(o).length && Object.assign(this.legacy_missingNodeRetryMap, o), Vt(e.texts).forEach((c)=>{
                ...
                for(const d in c.attributes)if (typeof d == "string") {
                    ...
                    if (h === null) u.removeAttribute(d);
                        ...
                        this.config.showWarning && console.warn("An error occurred may due to the checkout feature.", p1);
                    }
                    else if (d === "style") {
                        const p2 = h, m1 = u;
                        for(const b1 in p2)if (p2[b1] === !1) m1.style.removeProperty(b1);
                        else if (p2[b1] instanceof Array) {
                            const S1 = p2[b1];
                            m1.style.setProperty(b1, S1[0], S1[1]);
                        } else {
                            const S2 = p2[b1];
                            m1.style.setProperty(b1, S2);
                        }
                    }
                }
            });
            ...
            if ((r = e.adds) == null || r.forEach(({ rule: i , index: l  })=>{
                try {
                    if (Array.isArray(l)) {
                        ...
                        const c1 = l === void 0 ? void 0 : Math.min(l, n.cssRules.length);
                        n?.insertRule(i, c1);
                    }
                } catch  {}
        ...
        legacy_resolveMissingNode(e, n, r, o) {
            ...
            if (l) {
                const { node: c1 , mutation: u1  } = l;
                n.insertBefore(c1, r.nextSibling), delete e[u1.node.id], delete this.legacy_missingNodeRetryMap[u1.node.id], (u1.previousId || u1.nextId) && this.legacy_resolveMissingNode(e, n, c1, u1);
            }
        }
        ...
        drawMouseTail(e) {
            ...
            const { lineCap: n , lineWidth: r , strokeStyle: o , duration: a  } = this.config.mouseTail === !0 ? Ct : Object.assign({}, Ct, this.config.mouseTail), s = ()=>{
                if (!this.mouseTail) return;
    ...
    return ee.EventType = C, ee.IncrementalSource = N, ee.MouseInteractions = j, ee.Replayer = Ns, ee.ReplayerEvents = O, ee.addCustomEvent = Cs, ee.freezePage = Is, ee.record = be, ee.utils = kr, Object.defineProperty(ee, "__esModule", {
        value: !0
    }), ee;
}({}); //# sourceMappingURL=rrweb.min.js.map

//# sourceMappingURL=send.66a2c564.js.map
